...
import { ImageInput } from "@/app/dashboard-components/image-input";
import type { IImageInputFile } from "@/app/dashboard-components/image-input";
import React, { useState } from "react";
import { Image } from "antd";

type Props = {
  setAvatar: React.Dispatch<React.SetStateAction<IImageInputFile[]>>;
  avatar: IImageInputFile[];
};
const CrudAvatarUpload = (props: Props) => {
