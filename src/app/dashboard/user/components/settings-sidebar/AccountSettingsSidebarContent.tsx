...
import { Scrollspy } from "@/app/dashboard-components/scrollspy/Scrollspy";
import { useLayout } from "@/providers";
import { observer } from "mobx-react-lite";
import { AccountSettingsSidebar } from "./AccountSettingsSidebar";
import { EmploymentAndIncomeDetails } from "./blocks/EmploymentAndIncomeDetails";
import { FinancialInformation } from "./blocks/FinancialInformation";
import { CreditHistory } from "./blocks/CreditHistory";
import { MaritalFinancialStatus } from "./blocks/MaritalFinancialStatus";
import { LegalAndResidencyStatus } from "./blocks/LegalAndResidencyStatus";
...
const AccountSettingsSidebarContent = observer(() => {
  ...
  return (
    <div className="flex grow gap-5 lg:gap-7.5">
      ...
      <div className="flex flex-col items-stretch grow gap-5 lg:gap-7.5">
        <BasicSettings />
        <AdvancedSettingsAddress />
        <MaritalFinancialStatus />
        <LegalAndResidencyStatus />
