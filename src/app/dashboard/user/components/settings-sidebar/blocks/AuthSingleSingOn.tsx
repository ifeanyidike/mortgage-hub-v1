        ...
        {`
          .singl-sign-on-bg {
            background-image: url('${toAbsoluteUrl(
              "/media/images/2600x1600/bg-2.png"
            )}');
          }
          .dark .singl-sign-on-bg {
            background-image: url('${toAbsoluteUrl(
              "/media/images/2600x1600/bg-2-dark.png"
            )}');
          }
        `}
      </style>
            ...
            <style>
              {`
                .sso-active:has(:checked) {
                  background-image: url('${toAbsoluteUrl(
                    "/media/images/2600x1600/bg-1.png"
                  )}');
                }
                .dark .sso-active:has(:checked) {
                  background-image: url('${toAbsoluteUrl(
                    "/media/images/2600x1600/bg-1-dark.png"
                  )}');
                }
              `}
            </style>
