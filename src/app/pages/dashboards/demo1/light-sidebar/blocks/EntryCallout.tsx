...
import { CommonAvatars } from "@/app/partials/common";
    ...
    <Fragment>
        ...
        {`
          .entry-callout-bg {
            background-image: url('${toAbsoluteUrl(
              "/media/images/2600x1600/2.png"
            )}');
          }
          .dark .entry-callout-bg {
            background-image: url('${toAbsoluteUrl(
              "/media/images/2600x1600/2-dark.png"
            )}');
          }
        `}
      </style>
      ...
      <div className={`card h-full ${className}`}>
        ...
        <div className="card-footer justify-center">
          <Link href="/account/home/get-started" className="btn btn-link">
            Get Started
          </Link>
        </div>
      </div>
