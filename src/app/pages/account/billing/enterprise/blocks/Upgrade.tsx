...
import { CommonHexagonBadge } from "@/app/partials/common";
  ...
  return (
    <Fragment>
        ...
        {`
          .upgrade-bg {
            background-image: url('${toAbsoluteUrl(
              "/media/images/2600x1200/bg-14.png"
            )}');
          }
          .dark .upgrade-bg {
            background-image: url('${toAbsoluteUrl(
              "/media/images/2600x1200/bg-14-dark.png"
            )}');
          }
        `}
      </style>
      ...
      <div className="card rounded-xl">
        <div className="flex items-center justify-between grow gap-5 p-5 rtl:bg-[center_left_-8rem] bg-[center_right_-8rem] bg-no-repeat bg-[length:700px] upgrade-bg flex-col md:flex-row">
