...
import { DataGrid, DefaultTooltip, KeenIcon } from "@/app/dashboard-components";
    ...
    () => [
      {
        ...
        cell: (info) => (
          <span
            className={`badge badge-dot size-2 ${info.row.original.status}`}
          ></span>
        ),
        meta: {
          className: "w-[100px]",
      ...
      },
      {
        ...
        header: () => (
          <>
            <DefaultTooltip
              title="Verify the identity of a user trying to access a resource"
              placement="left"
              className="max-w-48"
            >
      ...
      <div className="card-header">
        ...
        <div className="flex gap-5">
          <label className="switch switch-sm">
            <span className="switch-label">IP Allowlist Enabled</span>
            <input
              type="checkbox"
              value="1"
              name="check"
