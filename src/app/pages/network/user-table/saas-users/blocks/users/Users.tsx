...
import { DataGrid } from "@/app/dashboard-components";
    ...
    () => [
      {
        ...
        id: "user",
        header: () => (
          <span className="text-gray-700 font-normal">Subscriber</span>
        ),
        enableSorting: true,
        cell: (info: any) => (
      ...
      },
      {
        ...
        id: "labels",
        header: () => (
          <span className="text-gray-700 font-normal">Products</span>
        ),
        enableSorting: true,
        cell: (info: any) => (
      ...
      },
      {
        ...
        id: "license",
        header: () => (
          <span className="text-gray-700 font-normal">License</span>
        ),
        enableSorting: true,
        cell: (info: any) => (
          <div className="flex flex-col">
      ...
      },
      {
        ...
        id: "payment",
        header: () => (
          <span className="text-gray-700 font-normal">Latest Payment</span>
        ),
        enableSorting: true,
      ...
      },
      {
        ...
        id: "enforce",
        header: () => (
          <span className="text-gray-700 font-normal">Enforce 2FA</span>
        ),
        enableSorting: true,
        cell: (info: any) => (
      ...
      },
      {
        id: "actions",
        header: () => (
          <span className="text-gray-700 font-normal">Invoices</span>
        ),
        enableSorting: true,
