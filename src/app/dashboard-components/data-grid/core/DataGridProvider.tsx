...
export const DataGridProvider = <TData extends object>(
  ...
  //   mergedProps.filters ?? []
  // );
  const { filters, setFilters } = mergedProps;
  ...
  useEffect(() => {
    console.log("newSubscriptionData", mergedProps.newSubscriptionData);
    if (mergedProps.newSubscriptionData) {
      setData([mergedProps.newSubscriptionData, ...data]);
    }
  }, [mergedProps.newSubscriptionData]);
