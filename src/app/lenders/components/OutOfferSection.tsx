...
const OurOffersSection = () => {
  return (
    ...
    >
      ...
      <div className="relative z-10  flex flex-col items-center px-8 lg:px-32 max-w-screen-xl mx-auto text-center text-white">
        {/* Animated title */}
        <motion.h2
        ...
        >
          ...
          {[
            ...
            <motion.a
              key={index}
              className={cn(
                "flex flex-col items-center gap-2 lg:gap-4 p-4 py-4 lg:py-6 rounded-xl shadow-lg cursor-pointer",
            ...
            >
              <Image
                src={lender.src}
                alt={lender.label}
                className="w-28 h-28 lg:w-40 lg:h-40 rounded-lg object-contain border border-white p-1 lg:p-3"
              />
