...
const SelectLender = () => {
  return (
    <div className="bg-[#3185FC] px-36 py-16 max-lg:px-16">
      <h4 className="text-white text-6xl text-center mb-16">
        Select a Lender of your choice
      </h4>
      <div className="grid grid-cols-3 max-xl:grid-cols-2 gap-32 max-lg:gap-8">
        <Pane
...
const Pane = (props: Props) => {
  ...
  return (
    <div className="rounded-xl bg-white p-8 flex items-center flex-col">
      {icon}
