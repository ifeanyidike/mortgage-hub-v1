...
export default function SlideCarousel() {
  ...
  return (
    <div className="group container mx-auto border border-red-500">
      <motion.div
        className={cn(
      ...
      <div className="relative overflow-hidden">
        ...
        >
          ...
          <BiLeftArrow className="h-10 w-10 stroke-[1.5] transition-colors group-enabled:group-hover:text-gray-900 group-disabled:opacity-50" />
        </button>
        <button
          type="button"
        ...
        >
          ...
          <BiRightArrow className="h-10 w-10 stroke-[1.5] transition-colors group-enabled:group-hover:text-gray-900 group-disabled:opacity-50" />
        </button>
      </div>
    </div>
  );
