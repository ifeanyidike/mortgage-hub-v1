...
const BlogHighlights = () => {
  return (
    <div className="w-full px-24 max-2xl:px-8">
      ...
      <div className="w-full flex mt-4 gap-24 max-lg:flex-col max-2xl:gap-8 max-lg:gap-16  max-md:gap-8 max-lg:max-h-max max-h-[800px]">
        <div className="w-1/2 max-h-[800px] max-md:max-h-[700px] max-2xl:w-4/5 max-lg:w-full relative overflow-hidden">
          <Image
            src={BlogDiscussion}
...
const ItemPane = (props: Props) => {
  ...
  return (
    <div
      className={`flex flex-col py-16 px-8 box-border gap-4 rounded-xl max-xl:py-4 max-lg:py-16 max-md:py-4 ${
        hasShadow &&
